...
angular.module('html6', []).
    ...
    directive('countries', function(){
        return function(scope){
            scope.countries = ["United States", "Other/Not Country", "Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua; Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas"
